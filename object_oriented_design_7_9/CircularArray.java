 ...
 *         Question 7.9) CIRCULAR ARRAY: Implement a CircularArray class
 *         				that supports an array-like data structure which
 *         				can be efficiently rotated. If possible, the class
 *          			should be a generic type (also called a template)
